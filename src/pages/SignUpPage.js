  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-primary">
      ...
      <div className=" bg-[#f8f8f897] px-4 rounded-lg flex flex-col">
        ...
        <button className="border font-poppins text-base bg-secondary text-white mb-1 py-1 text-center rounded-full">Signup</button>
        <h5 className="font-poppins text-xs text-center mb-4">Already have account? <Link to="/login" className="text-secondary underline-offset-1">Login</Link></h5>
      </div>
    </div>
  )
}
